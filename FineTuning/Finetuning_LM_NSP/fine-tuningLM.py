...
def main():
    ...
    print("Loading Train Dataset", args.test_file)                                
    test_dataset =BERTDataset(args.test_file, tokenizer, seq_len=args.max_seq_length,
                                    corpus_lines=None, on_memory=args.on_memory)
    ...
    train_dataloader = DataLoader(test_dataset, sampler=test_sampler, batch_size=args.train_batch_size)
